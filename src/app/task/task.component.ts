...
export class TaskComponent {
  ...
  private buildQuestions() {
    if (this.experimentNumber == "1") {
      this.questions = [
        {
          question: "1. В каком варианте слово написано правильно?",
        ...
        {
          question: "2. В каком варианте слово написано правильно?",
        ...
        {
          question: "3. Какой вариант правильный?",
          answers: ["Одевать детей",
            "Надевать детей"],
          key: 0
        },
        {
          question: "4. В каком варианте слово написано правильно?",
          answers: ["Презумция",
            "Призумция",
            "Презумпция",
            "Призумпция"],
        ...
        {
          question: "5. В каком варианте слово написано правильно?",
          answers: ["Абревиатура",
            "Аббревиатура",
            "Абривиатура",
            "Аббривиатура"],
        ...
        {
          question: "6. Какой вариант правильный?",
          answers: ["На будущий год",
            "На будующий год"],
          key: 0
        },
        {
          question: "7. В каком варианте слово написано правильно?",
          answers: ["Коннсенсус",
            "Консенсус",
            "Консентсус",
            "Контсенсус"],
        ...
        {
          question: "8. В каком варианте ударение стоит правильно?",
          answers: ["прозорлИва",
            "прозОрлива"],
          key: 0
        },
        {
          question: "9. Какой вариант правильный?",
          answers: ["День рождение",
            "День рождения"],
          key: 1
        },
        {
          question: "10. В каком варианте ударение стоит правильно?",
          answers: ["прибЫв",
            "прИбыв"],
          key: 0
        },
        {
          question: "11. В каком варианте слово написано правильно?",
        ...
        {
          question: "12. В каком варианте слово написано правильно?",
        ...
        {
          question: "13. В каком варианте написано правильно?",
          answers: ["Мы позвали обоих одноклассниц",
            "Мы позвали обеих одноклассниц"],
          key: 1
        },
        {
          question: "14. В каком варианте ударение стоит правильно?",
          answers: ["ходАтайство",
            "ходатАйство"],
          key: 0
        },
    ...
    if (this.experimentNumber == "2") {
      this.questions = [
        {
          question: "1. В чём измеряется сила?",
          answers: ["В Ньютонах",
            "В Джоулях",
            "В Амперах"],
          key: 0
        ...
        {
          question: "2. Выберите правильный вариант",
          answers: ["I = U * R",
            "I = R / U",
            "I = U / R"],
          key: 2
        ...
        {
          question: "3. Чему приблизительно равна скорость света в вакууме?",
        ...
        {
          question: "4. Как называется стабильная элементарная частица с отрицательным зарядом?",
          answers: ["Электрон",
            "Позитрон",
            "Электрод"],
          key: 0
        ...
        {
          question: "5. Как выглядит формула 3-го закона Ньютона о сила действия и противодействия?",
          answers: ["F1 = -F2",
            "F = ma",
            "F = mc^2"],
          key: 0
        ...
        {
          question: "6. Что в физике понимается под \"нормальными условиями\"?",
        ...
        {
          question: "7. Что такое электролиз?",
        ...
        {
          question: "8. Что измеряется в Кельвинах?",
          answers: ["Температура",
            "Давление",
            "Мощность",
            "Напряжение"],
